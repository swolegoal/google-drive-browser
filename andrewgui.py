...
def choicebox(msg="Pick something."
    ...
    return __choicebox(msg,title,choices,ok_button,cancel_button)
...
def __choicebox(msg
    ...
    if len(choices) > 0:
        okButton = Button(buttonsFrame, takefocus=YES, text=ok_button, height=1, width=6)
        bindArrows(okButton)
    ...
    cancelButton = Button(buttonsFrame, takefocus=YES, text=cancel_button, height=1, width=6)
    bindArrows(cancelButton)
